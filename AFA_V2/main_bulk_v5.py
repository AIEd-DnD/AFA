...
def process_csv_file(input_csv_path, model_name="gpt-4o-2024-08-06", char_mode="w"):
    """
...
def run_all_combinations(input_csv_path, char_mode="w"):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
        ...
        for model in models:
            future = executor.submit(process_csv_file, input_csv_path, model, char_mode)
  ...
  python main_bulk.py --model claude --char wo            # Process only Claude without character validation
    ...
    try:
        ...
        if args.model == 'all':
            ...
            results = run_all_combinations(input_csv, args.char)
            ...
            output_path = process_csv_file(input_csv, model, args.char)
