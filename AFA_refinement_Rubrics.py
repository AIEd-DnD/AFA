...
evaluation_record = AFA.start_new_record("4o_Rubrics_expanded_v2_system_user")
print("The refinement record has been created.")
response_list = AFA.csv_to_list_of_dicts("Dataset/AFA_Bulk_Rubrics.csv")
...
for scenario_dict in response_list:
    ...
    system_message = AFA.assemble_Rubrics_system_prompt(subject, level, question, recipe, rubrics)
