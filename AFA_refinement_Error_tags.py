...
evaluation_record = AFA.start_new_record("4o_Error_tags_expanded_v2_system_user")
print("The refinement record has been created.")
response_list = AFA.csv_to_list_of_dicts("Dataset/AFA_Bulk_Error_tags.csv")
...
for scenario_dict in response_list:
    ...
    system_message = AFA.assemble_Error_tags_system_prompt(subject, level, question, recipe, error_tags)
