...
system_message = assemble_system_prompt = AFA.assemble_system_prompt(subject, level, question, error_tags=error_tags)
user_message = AFA.assemble_user_prompt(students_response)
response = AFA.get_annotations_system_user_gpt5(system_message, user_message)
print(response)