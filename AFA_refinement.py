...
evaluation_record = AFA.start_new_record("gpt5_system_user_minimal_reasoning_wo_json")
...
for scenario_dict in response_list:
    ...
    print('Trying response '+str(response_list.index(scenario_dict)+1) + ' of ' + str(len(response_list)) + ' responses.')
    #response_dict = {'data': students_response}
    ...
    try:
        ...
        full_LLM_response = AFA.get_annotations_system_user_gpt5(system_message, user_message)
